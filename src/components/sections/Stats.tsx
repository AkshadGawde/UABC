...
import { IndianRupee, Clock, BadgeCheck, Headset } from "lucide-react";
...
const cardsData = [
  {
    ...
    icon: IndianRupee,
    content:
      "Transparent and competitive pricing designed to deliver maximum value without compromising quality.",
    gradient: "from-blue-500/20 via-indigo-500/5 to-transparent",
    border: "group-hover:border-blue-500/50",
    iconColor: "text-blue-400"
  },
  {
    title: "Incredible TAT",
    icon: Clock,
    content:
      "Quick turnaround times ensuring timely delivery without delays or operational disruption.",
    gradient: "from-purple-500/20 via-fuchsia-500/5 to-transparent",
    border: "group-hover:border-purple-500/50",
    iconColor: "text-purple-400"
  },
  {
    title: "Quality & Comprehensive Work",
    icon: BadgeCheck,
    content:
      "Accurate, detailed, and well-structured deliverables aligned with industry and compliance standards.",
  ...
  },
  {
    ...
    icon: Headset,
    content:
      "Round-the-clock support ensuring continuous assistance whenever you need it.",
        ...
        <div className="mb-6 sm:mb-8 lg:mb-12 text-center max-w-3xl mx-auto px-2">
          ...
          >
            <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold mb-2 sm:mb-3 text-slate-900 dark:text-white">
              Why Choose
              <span className="text-accent-600 dark:text-accent-500"> Us</span>
            </h2>
