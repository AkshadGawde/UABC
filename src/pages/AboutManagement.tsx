    ...
    <div className="min-h-screen bg-light-bg dark:bg-dark-bg pt-24">
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-br from-accent-50 to-slate-50 dark:from-dark-card dark:to-dark-bg">
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-slate-900 dark:text-white">
              Leadership &{' '}
          ...
          >
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-2">
                ...
                <p className="text-accent-600 dark:text-accent-500 font-semibold text-lg mb-4">
                  Founder & CEO
                </p>
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  {['FIA', 'FIAI', 'FIII'].map((title) => (
                    <span
                      key={title}
                      className="flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 rounded-full text-sm font-medium text-blue-800 dark:text-blue-300"
                    >
                      <Award className="w-4 h-4" />
                      {title}
                    </span>
                  ))}
                  <span className="flex items-center gap-2 px-3 py-1 bg-orange-100 dark:bg-orange-900/30 rounded-full text-sm font-medium text-orange-800 dark:text-orange-300">
