...
const insightSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: {
      values: ['Technology', 'Business', 'Innovation', 'Industry', 'Research', 'Analysis'],
      message: 'Category must be one of: Technology, Business, Innovation, Industry, Research, Analysis'
    }
  },
  tags: [{
    type: String,
